...
func _enter_tree():
	...
	single_scene_instruction.text = "1.点击AnimationPlayer 2. 刷新 4.选动画 3.支持shift/ctrl多选"
	...
	invert_selection_button.text = "反选"
